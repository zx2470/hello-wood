...
// returns first instance of a class, needs dot before class name
document.querySelector('#id-of-element'); 
// returns first instance of a class, needs hash before id name
document.querySelector('div.good'); 
// gets div with class of 'good'

// querySelectorAll
document.querySelectorAll('a'); 
// returns an array of all anchor tags in a document

// getElementById
document.getElementById('id-of-element-goes-here'); 
// returns entire DOM node and whatever is included inside

// getElementByClassName
document.getElementsByClassName('class-name-here'); 
// returns an array of all dom nodes with that class
document.getElementsByClassName('class-name-here')[0]; 
// returns the first element with the class name 'class-name-here
...
gsapp.classList.remove('time-of-day'); 
// removes the class 'time-of-day' from an element
gsapp.classList.toggle('class-name'); 
// toggles a class on and off of an element

const newParagraph = document.createElement("p") 
// creates an HTML element of the given tag type
newParagraph.innerText = "hi im just a child"
document.body.appendChild(newParagraph); 
// adds a child HTML element to the body of the page
const greatDiv = document.createElement('div') 
// creates a div 
greatDiv.style.border = "2px solid gold";
greatDiv.innerHTML = '<p>something great goes here</p>'; 
// sets the inner content of the div
document.body.appendChild(greatDiv); 
// adds the div to the end of the body of the page

const greatChild = document.createElement("p"); 
// creates a p tag
greatChild.id = "child-element";
greatChild.innerText = "I'm inside the greatest div of all"; 
// sets the text of the p tag
greatDiv.appendChild(greatChild); 
// adds the p tag to the previously created div
